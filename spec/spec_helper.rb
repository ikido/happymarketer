...
Spork.prefork do
  ...
  RSpec.configure do |config|
    ...
    # page.find(:xpath, '//ul[@class="navigation"]//a[text()="Dataloads"]').trigger(:mouseover) 
    # Capybara.javascript_driver = :webkit # to use extended selenium features, like hover
    ...
    # automatically show saved page if scenario faled
    config.after(:each) do |scenario|
      save_and_open_age unless @exception.nil?
    end
